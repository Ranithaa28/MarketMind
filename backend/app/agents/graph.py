...
def build_graph():
    ...
    graph.add_node("market_research_node", _safe(node_market_research))
    graph.add_node("investment_estimate_node", _safe(node_investment_estimate))
    graph.add_node("location_recommendation_node", _safe(node_location_recommendation))
    graph.add_node("swot_and_canvases_node", _safe(node_swot_and_canvases))
    ...
    graph.add_edge("market_research_node", "investment_estimate_node")
    graph.add_edge("investment_estimate_node", "location_recommendation_node")
    graph.add_edge("location_recommendation_node", "swot_and_canvases_node")
    graph.add_edge("swot_and_canvases_node", "business_strategy_node")
    graph.add_edge("business_strategy_node", "success_score_node")
    graph.add_edge("success_score_node", END)

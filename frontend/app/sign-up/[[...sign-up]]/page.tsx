...
export default function Page() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-[#809fff] via-[#94a8f3] to-[#a2b5f7] px-6">
      ...
      <div className="relative z-10 w-full max-w-[900px] rounded-[2.5rem] bg-white/20 p-8 md:p-14 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] backdrop-blur-2xl border border-white/40 grid gap-12 md:grid-cols-2 md:gap-8 items-center flex-row-reverse">
        {/* Right Column (Form) */}
        ...
        {/* Left Column (Text) */}
        <div className="flex flex-col justify-center order-1 md:order-2 md:text-right">
          <h1 className="mb-4 text-4xl font-bold text-slate-900 tracking-tight">Join MarketMind</h1>
          <p className="text-slate-800 text-lg">Create an account to start validating your startup ideas with our AI agent today.</p>
        </div>
      </div>
    </div>
  );
